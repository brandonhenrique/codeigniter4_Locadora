...
class Locacao extends BaseController
{
    ...
    public function viewLocacoes()
    {
        ...
        {
            $locacoes[$chave]['editar'] = '<a href="editar_locacao/' . $linha['TB_FUNCIONARIO_ID'] . '"> ALTERAR </a>';
            $locacoes[$chave]['excluir'] = '<a href="excluir_locacaoes/' . $linha['TB_FUNCIONARIO_ID'] . '"> EXCLUIR </a>';       
        }   
