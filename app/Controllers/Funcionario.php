...
class Funcionario extends BaseController
{
    ...
    public function viewFuncionarios()
    {
        ...
        {
            $funcionarios[$chave]['editar'] = '<a href="editar_funcionario/' . $linha['TB_FUNCIONARIO_ID'] . '"> ALTERAR </a>';
            $funcionarios[$chave]['excluir'] = '<a href="excluirFuncionarios/' . $linha['TB_FUNCIONARIO_ID'] . '"> EXCLUIR </a>';       
        }   
